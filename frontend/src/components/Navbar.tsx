      ...
      <Container fluid="xl">
        ...
        <Navbar.Collapse id="novelis-navbar-nav" className="justify-content-between align-items-center mt-3 mt-lg-0">
          ...
          <Nav className="align-items-lg-center gap-1 my-2 my-lg-0">
            <Nav.Link as={NavLink} to="/" end className="nav-link-custom d-flex align-items-center gap-2 text-nowrap">
            ...
            <Nav.Link as={NavLink} to="/top-truyen" className="nav-link-custom d-flex align-items-center gap-2 text-nowrap">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <Nav.Link as={NavLink} to="/nap" className="nav-link-accent d-flex align-items-center gap-2 text-nowrap mx-lg-1 my-1 my-lg-0">
